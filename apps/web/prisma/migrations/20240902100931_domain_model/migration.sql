...
CREATE TABLE "activites" (
    ...
    "modification" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "suppression" TIMESTAMP(3),
    "type_lieu" "lieu_accompagnement",
    "lieu_autre_code_postal" TEXT,
    "lieu_autre_commune" TEXT,
    "lieu_autre_code_insee" TEXT,
    "lieu_autre_departement" TEXT,
    "autonomie" "autonomie",
    ...
    "titre_atelier" TEXT,
    "type_lieu_atelier" "lieu_atelier" NOT NULL,
...
-- CreateIndex
CREATE UNIQUE INDEX "accompagnements_activite_id_key" ON "accompagnements"("activite_id");
...
-- AddForeignKey
ALTER TABLE "activites" ADD CONSTRAINT "activites_lieu_activite_id_fkey" FOREIGN KEY ("lieu_activite_id") REFERENCES "structures"("id") ON DELETE SET NULL ON UPDATE CASCADE;
