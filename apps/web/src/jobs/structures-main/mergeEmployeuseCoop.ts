...
// REPRISE d'une mutation supprimée du code produit. `features/structures/use-cases/merge` a
// été retiré par 3242a9f5 : la Coop n'offre plus de fusion d'employeuses côté coop, puisque
// l'identité employeuse vit désormais dans `main`. Les jobs de réconciliation, eux, en ont
// encore besoin le temps d'amener les deux schémas en cohérence — d'où cette copie locale,
// qui vivra et mourra avec cette branche d'outillage plutôt que de rouvrir la feature.
//
