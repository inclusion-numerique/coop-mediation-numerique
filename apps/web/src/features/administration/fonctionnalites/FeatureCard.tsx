...
export const FeatureCard = ({
  ...
  <div className="fr-border-radius--16 fr-border fr-py-10v fr-px-8v fr-height-full fr-flex fr-direction-column fr-enlarge-link">
    ...
    >
      <div className="fr-flex fr-justify-content-space-between align-items-center fr-width-full fr-flex-0">
      ...
      <div
        className="fr-flex fr-justify-content-end fr-width-full fr-flex-content fr-flex-0"
        aria-hidden
      >
