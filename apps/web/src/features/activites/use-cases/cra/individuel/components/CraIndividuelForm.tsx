...
import { Label } from '@app/web/libs/ui/primitives/form/Label'
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)}>
      ...
      <formT.AppForm>
        ...
        <div>
          <div className="fr-flex fr-flex-gap-12v">
            <formT.AppField name="date">
              {(field) => (
                <field.InputGroup className="fr-flex-basis-0 fr-flex-grow-1">
                  <field.Input
                    isPending={isPending}
            ...
            <formT.AppField name="duree.duree">
              {(field) => (
                <field.Item className="fr-flex-basis-0 fr-flex-grow-1">
                  <field.Select
                    isPending={isPending}
                  ...
                  {field.state.value === 'personnaliser' && (
                    <div className="fr-flex fr-flex-gap-4v">
                      <formT.AppField name="duree.dureePersonnaliseeHeures">
                        {(field) => (
                      ...
                      <formT.AppField name="duree.dureePersonnaliseeMinutes">
                        {(field) => (
                          <div className="fr-flex-basis-0 fr-flex-grow-1">
                            <field.Input
                              isPending={isPending}
          ...
          <formT.AppField name="typeLieu">
            {(field) => (
              <field.Item className="fr-flex-basis-0 fr-flex-grow-1">
                <field.RadioButtons
                  classes={{ content: 'fr-display-grid fr-display-grid--4x1' }}
                  isPending={isPending}
      ...
      <div className="fr-btns-group fr-mt-12v fr-mb-30v">
        <Button type="submit" {...buttonLoadingClassname(isPending)}>
