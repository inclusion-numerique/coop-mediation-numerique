...
export const PadlockIcon: Pictogram = ({
  width = 80,
  height = 80,
  ...props
}) => (
  ...
  >
    <path
      ...
      d="M17,8c-0.6,0-1-0.4-1-1c0-0.6,0.4-1,1-1s1,0.4,1,1C18,7.6,17.6,8,17,8z M7,64c-0.6,0-1-0.4-1-1s0.4-1,1-1
    ...
    <path
      ...
      d="M39,42c-3.3,0-6,2.7-6,6c0,2.2,1.2,4.2,3,5.2V57c0,1.7,1.3,3,3,3s3-1.3,3-3v-3.8c1.8-1,3-3,3-5.2
    ...
    <path
      ...
      d="M61.5,59.7c0,1.5-1.2,2.5-2.8,2.8l-0.1,1h-1.2l-0.2-2.2c1.5-0.2,2.5-0.5,2.5-1.6c0-0.7-0.5-1.2-1.2-1.2
