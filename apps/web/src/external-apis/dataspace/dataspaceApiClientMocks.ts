 ...
 */
export const mockDataspaceMediateurCoordinateur: DataspaceMediateur = {
  id: 67890,
 ...
 */
export const mockDataspaceMediateurCoordinateurHorsDispositif: DataspaceMediateur =
  {
    id: 55555,
    is_coordinateur: true,
    is_conseiller_numerique: false,
...
// Test email mappings for consistent testing
export const mockDataspaceTestEmails = {
  conseillerNumerique: 'patrick.morie@conseiller-numerique.fr',
  coordinateur: 'coordinateur.test@example.fr',
