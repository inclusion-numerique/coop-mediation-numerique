...
export type DataspaceContrat = {
  ...
  date_debut: string | null // null is when dataspace has no idea when the contract started, common occurence
...
export type DataspaceMediateur = {
  ...
  pg_id: number | null
  structures_employeuses?: (DataspaceStructureEmployeuse | null)[] | null
