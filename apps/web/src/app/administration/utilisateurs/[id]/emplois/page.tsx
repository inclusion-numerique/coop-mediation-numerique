                ...
                items={[
                  {
                    ...
                    value: miseEnRelationActive.dateRecrutement
                      ? dateAsDay(
                          new Date(miseEnRelationActive.dateRecrutement),
                        )
                      : 'Non renseigné',
                  },
                  {
                  ...
                  },
                  {
                    ...
                    value: miseEnRelationActive.dateFinDeContrat
                      ? dateAsDay(
                          new Date(miseEnRelationActive.dateFinDeContrat),
                        )
                      : 'Non renseigné',
                  },
                  {
                ...
                items={[
                  {
                    ...
                    value:
                      miseEnRelationActive.structureObj._id.toString('hex'),
                  },
                  {
                    label: 'Adresse',
                  ...
                  <Notice
                    title={
                      <>
                        ...
                        structure employeuse. Vous pouvez l’utiliser pour mettre
                        à jour les informations de la structure employeuse.
                      </>
                    }
