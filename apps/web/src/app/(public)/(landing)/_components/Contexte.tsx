...
export const Contexte = () => (
  <div className="fr-container">
    ...
    <div className="fr-flex fr-direction-md-row fr-direction-column fr-flex-gap-6v">
      <div className="fr-md-col fr-background-alt--blue-france fr-p-md-12v fr-border-radius--16">
        <Image
          className="fr-responsive-img fr-border-radius--16 fr-border-radius-md-bottom--0"
          src="/images/illustrations/landing-page/contexte/éloignement-numérique.svg"
          alt=""
          width={464}
          height={270}
        />
        <div className="fr-px-6v fr-pb-8v fr-p-md-0">
          ...
          <p>
            ...
            d’apport des technologies numériques pour les individus dans leur
            vie quotidienne, on parle de{' '}
            <strong>« capabilité numérique »</strong>.
          </p>
          <p>
      ...
      <div className="fr-md-col fr-background-alt--blue-france fr-p-md-12v fr-border-radius--16">
        ...
        <div className="fr-px-6v fr-pb-8v fr-p-md-0">
          ...
          <p>
            <strong>Œuvrant dans des structures variées</strong> comme des
            centres sociaux, médiathèques, collectivités territoriales,
            associations, espace France Services, ils sont répartis sur{' '}
            <Link
              className="fr-link"
