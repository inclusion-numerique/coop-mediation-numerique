...
export const Fonctionnalites = () => (
  <div className="fr-container">
    ...
    <div className="fr-background-alt--yellow-tournesol fr-p-md-12v fr-border-radius--16 fr-flex fr-align-items-center fr-flex-gap-16v fr-mt-md-32v fr-mt-12v">
      <div>
        <span
          className="fr-icon-flashlight-fill fr-icon--lg fr-text-label--yellow-tournesol fr-background-action-low--yellow-tournesol fr-border-radius--8 fr-p-5v"
          aria-hidden
        />
      </div>
      <div>
      ...
      <Link
        className="fr-btn fr-btn--secondary fr-text--nowrap"
